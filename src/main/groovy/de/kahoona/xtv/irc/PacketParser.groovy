...
class PacketParser {
  ...
  public static Packet getPacket (String channel, String bot, String server, String message) {
    ...
    if (matcher.matches ()) {
      return new Packet(packetId: matcher[0][1], size: matcher[0][2], name: matcher[0][3], bot: bot, channel: channel, date: new Date(), server: server)
    }
    return null
  }
