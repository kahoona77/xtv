(function () {
  ...
  module = angular.module('knalli.angular-vertxbus', ['ng']).value('enabled', true).value('debugEnabled', true).value('prefix', 'vertx-eventbus.').value('urlServer', '' + location.protocol + '//' + location.hostname + ':' + (location.port || 80)).value('urlPath', '/eventbus').value('reconnectEnabled', true).value('sockjsStateInterval', 10000).value('sockjsReconnectInterval', 10000).value('sockjsOptions', {});
