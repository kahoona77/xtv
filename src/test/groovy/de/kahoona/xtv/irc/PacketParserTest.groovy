...
class PacketParserTest extends GroovyTestCase {
  ...
  void testGetPacket () {
    ...
    Packet packet = packetParser.getPacket ('mg', 'test', '#89    0x [235M] Stand.Up.For.The.Week.S05E06.HDTV.x264-TLA.mp4')
    ...
    packet = packetParser.getPacket ('mg', 'test', '#167  0x [ 10G] Cliff.Richard-Still.Reelin.And.A.Rockin.Live.At.Sydney.Opera.House.2013.BluRay.DTS-HD.x264-LEGi0N.tar')
    assertNotNull (packet)
